            ...
            <div className="lg:flex lg:flex-row lg:items-center lg:gap-5 m-10">
                ...
                <div className="text-center font-serif flex flex-col gap-5 items-center">
                    ...
                    <div className="flex flex-row gap-5 w-full justify-center">
                        <a href=""><i className="fab fa-instagram text-3xl text-red-500 hover:scale-150 active:scale-150 transition transform duration-500 ease-in-out"></i></a>
                        <a href=""><i className="fab fa-linkedin text-3xl text-blue-500 hover:scale-150 active:scale-150 transition transform duration-500 ease-in-out"></i></a>
                        <a href=""><i className="fab fa-youtube text-3xl text-red-500 hover:scale-150 active:scale-150 transition transform duration-500 ease-in-out"></i></a>
                        <div className="flex items-center gap-2 hover:scale-120 active:scale-120 transition transform duration-500 ease-in-out">
                            ...
                            <h3 className="text-lg">+911234567890</h3>
                        </div>
                    </div>
